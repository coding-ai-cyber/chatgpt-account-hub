...
test('routes the complete visible React copy inventory through useLanguage', () => {
  ...
  const expectedKeysByFile: Record<string, string[]> = {
    'src/App.tsx': [
      ...
      'openedInBrowser', 'openedInBrowserFailed',
      ...
      'fullImportFailed', 'codexAppOpened', 'openCodexFailed', 'close',
      'openCodexApp', 'opening',
      'searchAccounts',
      'timedWarmup', 'exportSlimText', 'importing', 'importSlimText',
      'exportFullEncryptedFile', 'importFullEncryptedFile',
      'usageRefreshedSuccessfully', 'refreshFailed', 'accountRenamed',
      'renameFailed', 'clickDeleteAgainToConfirmRemoval', 'closeRunningCodexQuestion',
    ...
    'src/app/AppShell.tsx': [
      'openNavigation', 'minimize', 'restore', 'maximize', 'close',
      'closeNavigation',
    ],
    'src/components/layout/TopToolbar.tsx': [
      'openNavigation', 'codexProcessesRunning',
      'showAllAccountNamesAndEmails', 'hideAllAccountNamesAndEmails',
      'refreshingAllUsage', 'refreshAllUsage', 'warmingUpAllAccounts',
      'warmUpAllAccounts', 'addAccount', 'actionsMenu',
    ],
    'src/components/layout/Sidebar.tsx': [
      'navCurrentAccount', 'navCurrentAccountDescription', 'collapseSidebar',
    ...
    'src/pages/CurrentAccountPage.tsx': [
      ...
      'failedToLoadAccounts', 'retry', 'noAccountsYet', 'addFirstAccount',
      'addAccount', 'importAccounts', 'accountHidden', 'statusActive',
      'noAccountsConfigured', 'subscriptionStatus', 'openInBrowserAction',
      'refreshAccount', 'warmup', 'showInfo', 'hideInfo', 'autoWarmupLabel',
      'removeAccount', 'recentActivity', 'refresh', 'fastMode', 'totalThreads',
      'peakDay', 'last7DaysTitle', 'activityUnavailable', 'usageSummary',
      'viewFullStats', 'reported', 'statsLastUpdated', 'never',
    ],
    'src/pages/OtherAccountsPage.tsx': [
      'apiKey', 'unknown', 'expiryUnavailable', 'otherAccountsEmpty',
      'addFirstAccount', 'accountSearchPlaceholder', 'searchAccounts',
      'clearSearchFilters', 'sort', 'gridView', 'listView', 'noMatchingAccounts',
      'noResultsClearSearch', 'noAccountsConfigured', 'closeDetails',
      'statusActive', 'statusInactive', 'removeAccount', 'switch',
      'confirmRemoval', 'removeAccountWarning', 'keepAccount', 'removeForGood',
    ],
    'src/pages/UsageStatsPage.tsx': [
      'noAccountsConfigured', 'addFirstAccount', 'statsViewerTitle',
      'statsViewerDescription', 'statsAccountRequired', 'active', 'statusActive',
    ],
    'src/pages/HelpPage.tsx': [
      'helpLocalGuide', 'navHelpDescription', 'onlineDocs', 'reportIssue',
      'checkForUpdates',
    ],
    'src/pages/SettingsPage.tsx': [
      'pageSettings', 'navSettingsDescription', 'settingsAppearance',
      'themeDefaultMode', 'dark', 'light', 'themeModeOnlyDefault',
      'settingsLanguage', 'changeLanguageHint', 'language', 'chinese', 'english',
      'settingsTrayDock', 'tray', 'iconAndSession', 'hourlyAndWeekly', 'hidden',
      'dockIcon', 'showInDock', 'menuBarOnly', 'atLeastOneIconVisible',
      'settingsAccountBehavior', 'accountBehaviorDescription', 'autoWarmupAll',
      'timedWarmupEnabled', 'timeInputLabel', 'addTime', 'noTimesConfigured',
      'settingsLifecycle', 'closePreferenceDescription', 'closeCodex',
      'askEveryTime', 'gracefullyClose', 'forceClose',
      'reopenPreferenceDescription', 'reopenCodexAfterForceClose',
      'reopenDesktopApp', 'keepClosed',
    ],
    'src/TrayMenu.tsx': [
