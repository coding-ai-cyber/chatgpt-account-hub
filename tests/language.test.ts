...
test('routes the complete visible React copy inventory through useLanguage', () => {
  ...
  const expectedKeysByFile: Record<string, string[]> = {
    ...
    'src/components/dashboard/CurrentAccountDashboard.tsx': [
      'usageSummary', 'lifetimeTokens', 'todayTokens',
      'lastSevenDayTokens', 'currentStreakDays', 'days',
      'recentActivity', 'refresh', 'fastMode', 'totalThreads',
      'peakDate', 'activityUnavailable', 'viewFullStats',
      'usageAdviceTitle',
    ],
    'src/pages/CurrentAccountPage.tsx': [
      'failedToLoadAccounts', 'retry', 'noAccountsYet', 'addFirstAccount',
      'addAccount', 'importAccounts',
    ],
