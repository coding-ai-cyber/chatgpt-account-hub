...
const englishTranslations = {
  ...
  warmed: "warmed",
  failed: "failed",
  productName: "ChatGPT Account Hub",
  openCodexSwitcher: "Open ChatGPT Account Hub",
  quit: "Quit",
  dock: "Dock",
  show: "Show",
  menuBar: "Menu Bar",
  ...
  welcome: "Welcome to ChatGPT Account Hub",
  ...
  atLeastOneIconVisible: "At least one of the Dock or tray icons stays visible so you can reopen ChatGPT Account Hub.",
  ...
  afterClosingSwitchTo: "After closing Codex, ChatGPT Account Hub will switch to {name}.",
  reopenCodexDesktopAfterClose: "Reopen Codex desktop after close",
  keepSwitcherInDock: "Keep ChatGPT Account Hub in the Dock?",
  closedWindowDockOrMenuBar: "When the window is closed, ChatGPT Account Hub can stay in the Dock or live only in the menu bar.",
  ...
  removeAccountWarning: "This removes the account from ChatGPT Account Hub. This action cannot be undone.",
...
const chineseTranslations: Record<TranslationKey, string> = {
  ...
  warmup: "预热", warmed: "已预热", failed: "失败", productName: "ChatGPT 账号管家", openCodexSwitcher: "打开 ChatGPT 账号管家", quit: "退出",
  ...
  failedToSave: "保存失败：{message}", unknownError: "未知错误", welcome: "欢迎使用 ChatGPT 账号管家", getStarted: "开始使用",
  ...
  copiedBang: "已复制！", generateLoginLink: "生成登录链接", weeklyLimit: "每周限制", atLeastOneIconVisible: "Dock 或托盘图标至少有一个保持可见，以便重新打开 ChatGPT 账号管家。",
  ...
  currentStreak: "当前连续天数", peakDay: "峰值日", peakDate: "峰值日期",
  usageAdviceTitle: "使用建议", usageAdviceHealthy: "当前额度充足，无需切换账户。",
  usageAdviceWatchReset: "有额度周期即将用尽，请关注最近的重置时间。",
  usageAdviceRefresh: "刷新此账户以获取最新额度建议。", moreAccountActions: "更多账户操作",
  quotaHealthy: "状态良好", resetCreditExpiryDetails: "重置额度过期详情", resetsNow: "立即重置", resetsIn: "{reset} 后重置",
  ...
  afterClosingSwitchTo: "关闭 Codex 后，ChatGPT 账号管家将切换到 {name}。", reopenCodexDesktopAfterClose: "关闭后重新打开 Codex 桌面端",
  keepSwitcherInDock: "将 ChatGPT 账号管家保留在 Dock 中？", closedWindowDockOrMenuBar: "窗口关闭后，ChatGPT 账号管家可保留在 Dock 中或仅驻留菜单栏。",
  ...
  confirmRemoval: "移除账户？", removeAccountWarning: "这会从 ChatGPT 账号管家中移除该账户，操作无法撤销。",
  ...
  helpTrayBody: "托盘弹窗保持紧凑，并同步当前主题颜色。\nDock 与托盘显示模式可在设置中修改。\n关闭窗口后，ChatGPT 账号管家可继续保留在 Dock 或菜单栏。",
